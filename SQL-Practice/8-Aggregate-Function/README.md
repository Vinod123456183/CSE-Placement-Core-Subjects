...
# SQL Aggregate Functions Practice: Easy → Advanced

**Master counting, summing, averaging, and analyzing data using SQL aggregates.**
...
21. Find the median order amount per product (if your DB supports it).
...
* Use **HAVING** to filter aggregates (cannot use WHERE for aggregated results).
* Test **NULL values**: SUM/AVG ignores NULLs by default.
