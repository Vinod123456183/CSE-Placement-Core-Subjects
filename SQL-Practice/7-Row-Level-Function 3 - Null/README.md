...
# SQL NULL Handling Practice: Easy → Advanced

**Master handling NULLs in SQL for data cleaning, reporting, and ETL tasks.**
...
16. Find orders where either `product_id` or `customer_id` is NULL.
